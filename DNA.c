/********************subaskodyThushanA2.c*************************************
Student Name: Thushan Subaskody     Email Id: tsubasko
Due Date: Nov. 4, 2022              Course Name: CIS 1300
...
Compiling:
gcc -std=c99 -Wall subaskodyThushanA2.c main.c
